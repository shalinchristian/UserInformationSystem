...
|------|--------------|----------|
| **Home Page** | Landing page after login | ![Home Page](screenshots/home.png) |
| **Register Page** | User registration form | ![Register Page](screenshots/register.png) |
| **Login Page** | Secure user login | ![Login Page](screenshots/login.png) |
| **Profile Page** | Displays user details and photo | ![Profile Page](screenshots/profile.png) |
| **Update Details** | Allows editing and uploading new profile photo | ![Update Details](screenshots/update.png) |
| **Achievements List** | Displays added achievements | ![Achievements List](screenshots/achievements.png) |
